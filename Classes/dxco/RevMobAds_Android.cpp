...
void RevMobAds_Android::LoadFullscreen()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("loadFullscreen","()V");
#endif
}

void RevMobAds_Android::ShowLoadedFullscreen()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("showLoadedFullscreen","()V");
#endif
}
...
void RevMobAds_Android::LoadPopup()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("loadPopup","()V");
#endif
}

void RevMobAds_Android::ShowLoadedPopup()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("showLoadedPopup","()V");
#endif
}
...
void RevMobAds_Android::LoadBanner()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("loadBanner","()V");
#endif
}

void RevMobAds_Android::ShowLoadedBanner()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("showLoadedBanner","()V");
#endif
}

void RevMobAds_Android::HideLoadedBanner()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("hideLodedBanner","()V");
#endif
}
...
void RevMobAds_Android::LoadLink()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("loadLink","()V");
#endif
}

void RevMobAds_Android::OpenLoadedLink()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	callStaticVoidMethod("openLoadedLink","()V");
#endif
}
