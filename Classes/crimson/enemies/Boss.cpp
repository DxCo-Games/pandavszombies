...
Boss::Boss(GameModel* model, cocos2d::CCSprite* sprite, std::map<int, Animation*>& animations, int level, std::string type, int extraType) :
	Enemy(model, sprite, animations, level, type, extraType),
